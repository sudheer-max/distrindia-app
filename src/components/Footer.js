            ...
            <footer className="ps-footer">
                <div className="container">
                    <div className="ps-footer--contact">
                        <div className="row">
                            <div className="col-12 col-lg-4">
                                ...
                                <p> <b>Head office: </b>PLOT NO E-71, ADDITIONAL MIDC, PATALGANGA, TAL- PANVEL, DIST - RAIGAD PANVEL RAIGARH MH 410207 IN</p>
                                <p> <b>Email us: </b><Link to="welcome@distrindia.com" className="__cf_email__">welcome@distrindia.com</Link></p>
                            </div>
                            <div className="col-12 col-lg-4">
                                <div className="row">
                    ...
                    <div className="row ps-footer__copyright">
                        <div className="col-12 col-lg-6 ps-footer__text">&copy; { new Date().getFullYear()} Distrindia Pvt. Ltd. All Rights Reversed.</div>
            ...
            <div className="ps-footer-mobile">
                <div className="menu__content">
                    <ul className="menu--footer">
                        <li className="nav-item"><Link className="nav-link" to="/"><i className="icon-home3"></i><span>Home</span></Link></li>
                        <li className="nav-item"><Link className="nav-link footer-category" to="/"><i className="icon-list"></i><span>Category</span></Link></li>
                        <li className="nav-item"><Link className="nav-link footer-cart" to="/"><i className="icon-cart"></i><span className="badge bg-warning">3</span><span>Cart</span></Link></li>
                        <li className="nav-item"><Link className="nav-link" to="/"><i className="icon-heart"></i><span>Wishlist</span></Link></li>
                        <li className="nav-item"><Link className="nav-link" to="/"><i className="icon-user"></i><span>Account</span></Link></li>
                    </ul>
                </div>
            </div>
            ...
            <nav className="navigation--mobile">
                ...
                <div className="navigation__footer">
                    <ul className="menu--icon">
                        ...
                        <li className="footer-item"><Link className="footer-link" to="/"><i className="icon-telephone"></i><span>HOTLINE: <span className='text-success'>84228-27990</span> (Free)</span></Link></li>
                    </ul>
                </div>
            </nav>
        </>
