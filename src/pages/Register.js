        ...
        <main className="no-main">
            ...
            <section className="section--registration">
                <div className="container">
                    ...
                    <p className="page__subtitle">Get
                        started by just filling
                        out one simple form</p>
                            ...
                            col-lg-7">
                                    <div className="registration__info">
                                        ...
                                        form-group--block"><label>Email:
                                                    <span>*</span></label><input className="form-control" type="eamil"
                                ...
                                <div className="col-12
                            col-lg-5">
                                    <h3 className="registration__title">Company
                                        Information</h3>
                                    <div className="registration__box">
                                        <div className="form-row">
                                            <div className="col-12
                                        form-group--block"><label>Company
                                                    name:
                                                    <span>*</span></label><input className="form-control" type="text"
                                                        name="cname" value={cname} onChange={e => setCname(e.target.value)} /></div>
                                            <div className="col-12
                                        form-group--block"><label>address:
                                                </label><input className="form-control" type="text" name="address" value={address} onChange={e => setAddress(e.target.value)} />
                                            </div>
                                            <div className="col-12
                                        form-group--block"><label>Phone
                                                    number:
                                                    <span>*</span></label><input className="form-control" type="text"
                                                        name="mobile" value={mobile} onChange={e => setMobile(e.target.value)} /></div>
                                        </div>
                                    </div>
                                    <p>By
                                        creating
                                        ...
                                        agree to
                                        Distrindia
                                        <span className="text-success">Conditions
                                            of
                                            Use
                                        </span>and
                                        <span className="text-success">Privacy
                                            Notice.</span>
                                    </p><button className="btn
                                ps-button" type="submit">Register</button>
                                </div>
                            </div>
                        </form>
                    </div>
